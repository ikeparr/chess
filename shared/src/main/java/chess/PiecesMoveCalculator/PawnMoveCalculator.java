        ...
        if (teamColor == ChessGame.TeamColor.WHITE) {
            ...
            if (startRow == 2) {
                if (PieceMoveCalculator.moveInBounds(startRow + 1, startColumn)) {
                    if (PieceMoveCalculator.isFreeSquare(chessBoard, startRow + 1, startColumn)) {
                        ...
                        if (PieceMoveCalculator.moveInBounds(startRow + 2, startColumn)) {
                            if (PieceMoveCalculator.isFreeSquare(chessBoard, startRow + 2, startColumn)) {
            ...
            if (PieceMoveCalculator.moveInBounds(startRow + 1, startColumn - 1)) {
                if (PieceMoveCalculator.isOpponentSquare(chessBoard, startRow + 1, startColumn - 1, teamColor)) {
                    if (startRow + 1 == 8) {
